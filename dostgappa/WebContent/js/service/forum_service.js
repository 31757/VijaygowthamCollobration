		...
		.factory(
				...
				[
						...
						function($http, $q) {
							...
							var REST_SERVICE_URI = 'http://localhost:9050/vanuchatserver/forum';
								...
								$http
										...
										.then(
												...
												function(errResponse) {
													console
															.error('Error while fetching Forumss');
													deferred
															.reject(errResponse);
												});
